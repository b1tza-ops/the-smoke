...
class StreakProgressTests(unittest.TestCase):

    def test_streak_progress_starts_towards_first_milestone(self):
    ...
    def test_streak_progress_advances_between_milestones(self):
    ...
    def test_streak_progress_caps_after_final_milestone(self):
    ...
    def test_negative_streak_is_safely_normalised(self):

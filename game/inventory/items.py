...
ITEMS = (
    ...
    ItemDefinition("sports_drink", "Sports Drink", "boost", "Restores up to 30 energy.", "items/sports-drink.webp", True, 5, "energy", 30),
    ItemDefinition("painkillers", "Painkillers", "medical", "Restores up to 15 health.", "items/painkillers.webp", True, 10, "health", 15),
    ItemDefinition("bandage_roll", "Bandage Roll", "medical", "Restores up to 10 health.", "items/bandage-roll.webp", True, 15, "health", 10),
    ItemDefinition("protein_bar", "Protein Bar", "boost", "Restores up to 8 energy.", "items/protein-bar.webp", True, 10, "energy", 8),
    ItemDefinition("bolt_cutters", "Bolt Cutters", "utility", "Heavy cutters used in selected crimes.", "items/bolt-cutters.webp", True, 5),
    ItemDefinition("glass_cutter", "Glass Cutter", "utility", "A precise tool for quiet entry.", "items/glass-cutter.webp", True, 10),
    ItemDefinition("burner_phone", "Burner Phone", "utility", "A disposable phone for discreet work.", "items/burner-phone.webp", True, 5),
    ItemDefinition("duct_tape", "Duct Tape", "utility", "Useful for improvised plans.", "items/duct-tape.webp", True, 10),
    ItemDefinition("police_baton", "Police Baton", "weapon", "A balanced close-range weapon.", "items/police-baton.webp", False, 1, equipment_slot="primary", strength_bonus=8),
    ItemDefinition("tire_iron", "Tyre Iron", "weapon", "Compact steel with a punishing swing.", "items/tyre-iron.webp", False, 1, equipment_slot="primary", strength_bonus=10),

...
ITEMS = (
    ...
    ItemDefinition("sports_drink", "Sports Drink", "boost", "Restores up to 30 energy.", "items/energy-drink.webp", True, 5, "energy", 30),
    ItemDefinition("painkillers", "Painkillers", "medical", "Restores up to 15 health.", "items/first-aid-kit.webp", True, 10, "health", 15),
    ItemDefinition("bandage_roll", "Bandage Roll", "medical", "Restores up to 10 health.", "items/first-aid-kit.webp", True, 15, "health", 10),
    ItemDefinition("protein_bar", "Protein Bar", "boost", "Restores up to 8 energy.", "items/energy-drink.webp", True, 10, "energy", 8),
    ItemDefinition("bolt_cutters", "Bolt Cutters", "utility", "Heavy cutters used in selected crimes.", "items/crowbar.webp", True, 5),
    ItemDefinition("glass_cutter", "Glass Cutter", "utility", "A precise tool for quiet entry.", "items/screwdriver.webp", True, 10),
    ItemDefinition("burner_phone", "Burner Phone", "utility", "A disposable phone for discreet work.", "items/lockpick.webp", True, 5),
    ItemDefinition("duct_tape", "Duct Tape", "utility", "Useful for improvised plans.", "items/lockpick.webp", True, 10),
    ItemDefinition("police_baton", "Police Baton", "weapon", "A balanced close-range weapon.", "items/baseball-bat.webp", False, 1, equipment_slot="primary", strength_bonus=8),
    ItemDefinition("tire_iron", "Tyre Iron", "weapon", "Compact steel with a punishing swing.", "items/crowbar.webp", False, 1, equipment_slot="primary", strength_bonus=10),
    ItemDefinition("hatchet", "Hatchet", "weapon", "A short, heavy chopping weapon.", "items/claw-hammer.webp", False, 1, equipment_slot="primary", strength_bonus=12),
    ItemDefinition("survival_knife", "Survival Knife", "weapon", "A stronger secondary blade.", "items/kitchen-knife.webp", False, 1, equipment_slot="secondary", strength_bonus=8),
    ItemDefinition("denim_jacket", "Reinforced Denim Jacket", "armour", "Street clothing with sewn-in padding.", "items/padded-hoodie.webp", False, 1, equipment_slot="body", defence_bonus=7),
    ...
    ItemDefinition("combat_gloves", "Combat Gloves", "armour", "Padded gloves with reinforced knuckles.", "items/leather-gloves.webp", False, 1, equipment_slot="hands", defence_bonus=5),
    ItemDefinition("cargo_trousers", "Padded Cargo Trousers", "armour", "Hard-wearing trousers with light padding.", "items/padded-hoodie.webp", False, 1, equipment_slot="legs", defence_bonus=5),
    ...
    ItemDefinition("tactical_boots", "Tactical Boots", "armour", "Heavy boots designed for dangerous work.", "items/work-boots.webp", False, 1, equipment_slot="feet", defence_bonus=7),

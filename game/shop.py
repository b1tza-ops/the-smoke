...
DISTRICT_SHOPS = {
    "camden": {
        ...
        "items": (
            ...
            ShopItem("brick", "Half Brick", "Loose masonry, thrown once and gone.", 40, 10, 40),
            ShopItem("glass_bottle", "Glass Bottle", "An empty bottle, sold for the deposit.", 65, 8, 30),
...
SPECIALIST_SHOPS = {
    "kingsland_arms": {
        ...
        "items": (
            ...
            ShopItem("flash_banger", "Flash Banger", "Surplus stun charge, single use.", 340, 2, 8),
            ShopItem("petrol_bomb", "Petrol Bomb", "A rag, a bottle and a very short future.", 520, 1, 5),
